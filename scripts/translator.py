...
class MSSQL():
    def __init__(self, options, dbwrenchObj):
        ...
        self.schema_description = options.description

    def build_ddl(self):
        ddl_text = self.schema_description

        #Drop the database called 'WaM-DaM' if it exists and then create a new database called 'WaM-DaM'
     #    ddl_text = ''
     #    ddl_text += '-- Adel Abdallah, PhD Candidate Utah State University, 2017\n'
	# ddl_text += '\n'
     ...
     #    ddl_text += '\n'
     #    ddl_text += '-- Generated by Adel Abdallah May 1, 2017 based on WaMDaM XML design named WaMDaMMay1_2017.xml generated by DbWrench V4.03 @ http://www.dbwrench.com/\n'
     #    ddl_text += '-- WaMDaM All rights reserved. See Licence @ wamdam.org \n'
     #    ddl_text += '\n'
     ...
     #    ddl_text += '-- Then click "execute". The script should run successfully and create the 41 empty tables of WaM-DaM\n'
     #    ddl_text += '\n'
    #
     #    ddl_text += '----------------------------------------------------------------------------------------\n'
...
class POSTGRESQL():
    ...
    #
     ...
     #    ddl_text += '\n'
     #    ddl_text += '-- Generated by Adel Abdallah May1, 2017 based on WaMDaM XML design named WaMDaMMay1_2017.xml DbWrench V4.0 @ http://www.dbwrench.com\n'
     #    ddl_text += '-- WaMDaM All rights reserved. See Licence @ wamdam.org \n'
     #    ddl_text += '\n'
...
class SQLITE():
    ...
    #
     ...
     #    ddl_text += '\n'
     #    ddl_text += '-- Generated by Adel Abdallah May 1, 2017 based on WaM-DaM XML design named WaMDaMMay1_2017.xml generated by DbWrench V4.03 @ http://www.dbwrench.com\n'
     #    ddl_text += '-- WaMDaM All rights reserved. See Licence @ wamdam.org \n'
     #    ddl_text += '\n'
     ...
     #    ddl_text += '--Then click Run SQL. The script should run successfully and create the 41 empty tables of WaM-DaM\n'
     #    ddl_text += '\n'
     #    ddl_text += '--------------------------------------------------------------------------------------------------'
