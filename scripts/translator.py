...
class MSSQL():
    ...
    def build_ddl(self):
        ...
        ddl_text = ''
        ddl_text += '-- Adel Abdallah, PhD Candidate, Utah State University, December 2018\n'
	ddl_text += '\n'
        ddl_text += '--This is a Data Definition Language (DDL) script that\n'
        ddl_text += '--generates a blank schema of the Water Management Data Model (WaMDaM)\n'
        ddl_text += '-- for Microsoft SQL Server database.\n'
        ddl_text += '\n'
        ddl_text += '-- Generated by Adel Abdallah December 11, 2018 based on WaMDaM XML design named WaMDaM_DBWrench_Schema_1.01 generated by DbWrench V4.04 @ http://www.dbwrench.com/\n'
        ddl_text += '-- WaMDaM All rights reserved. See BSD 3-Clause Licence @ https://github.com/WamdamProject/WaMDaM-software-ecosystem \n'
        ddl_text += '\n'
        ddl_text += '-- To create a blank WaMDaM database in SQL Server,\n'
        ...
        ddl_text += '-- Then click "execute". The script should run successfully and create the 41 empty tables of WaMDaM\n'
        ddl_text += '\n'

        ddl_text += '----------------------------------------------------------------------------------------\n'

        ddl_text += "-- Drop the database called 'WaMDaM' if it exists and then create a new database called 'WaMDaM'"
        ddl_text += '\nUSE master;'
        ddl_text += '\nGO\n'
...
class POSTGRESQL():
    ...
    def build_ddl(self, include_postgis=True):
        ...
        ddl_text = ''
        ddl_text += '-- Adel M. Abdallah, PhD Candidate, Utah State University, December 2018\n'
	ddl_text += '\n'
        ...
        ddl_text += '\n'
        ddl_text += '-- Generated by Adel Abdallah December, 2018 based on WaMDaM XML design named WaMDaM_DBWrench_Schema_1.05.xml DbWrench V4.04 @ http://www.dbwrench.com\n'
        ddl_text += '-- WaMDaM All rights reserved. See BSD 3-Clause Licence @ https://github.com/WamdamProject/WaMDaM-software-ecosystem \n'
        ddl_text += '\n'
        ...
        ddl_text += '--Then click execute. The script should run successfully and create the 40 empty tables of WaMDaM"\n'
			# Adel has commented this part because it is not used in WaMDaM so far  
        if include_postgis:
            ddl_text += '\n'
            ddl_text += '--Adel has commented this part because it is not used in WaMDaM so far \n'
...
class MYSQL():
    ...
    def build_ddl(self, include_postgis=True):
        ...
        ddl_text = ''
        ddl_text += '-- Adel Abdallah, PhD Candidate, Utah State University, 2018\n'
	ddl_text += '\n'
        ...
        ddl_text += '\n'
        ddl_text += '-- Generated by Adel Abdallah December, 2018 based on WaMDaM XML design named WaMDaM_DBWrench_Schema_1.05.xml generated by DbWrench V4.04 @ http://www.dbwrench.com/ \n'
        ddl_text += '-- WaMDaM All rights reserved. See BSD 3-Clause Licence @ https://github.com/WamdamProject/WaMDaM-software-ecosystem \n'
        ddl_text += '\n'
...
class SQLITE():
	...
	ddl_text += '\n'
        ...
        ddl_text += '--Then click Run SQL. The script should run successfully and create the 41 empty tables of WaMDaM\n'
        ddl_text += '\n'
        ddl_text += '--------------------------------------------------------------------------------------------------'
